...
- [ ] **Phase 53: v3.1 Carry-Forwards** — Skill input/output schemas + installer upgrade/uninstall + MCP `amauta/bearings` + `amauta/agent-hydrate` + hydration auto-invoke at Task() spawn sites (POLISH-01..05). Plan 53-01 (POLISH-01) COMPLETE 2026-05-14: SkillFrontmatter input_schema + output_schema at positions 8+9 + validateJsonSchemaShape in skill-compiler.cjs + 13 Python tests + 11 Node tests.
