...
- [ ] **Phase 49: Module CLI + Lifecycle** — `gsd-amauta module install/uninstall/upgrade <name>` subcommands with idempotency, dry-run, and rollback (MOD-03, MOD-04). Depends on 48. Plan 49-01 COMPLETE 2026-05-13; Plan 49-02 COMPLETE 2026-05-13 (install/uninstall 7-step orchestrators + rollback engine + 20 new tests, 49 total pass; SC1+SC4 locked); Plan 49-03 COMPLETE 2026-05-13 (upgrade() 8-step expand-and-contract + compute_migration_delta + v2 fixture + 19 new tests, 68 total pass; SC3+partial_rollback locked).
