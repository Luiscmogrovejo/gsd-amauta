...
- [x] **Phase 44: Cross-IDE Installer** — `npx gsd-amauta init` 7-step flow; IDE auto-detection; non-interactive CI mode; legacy migration; 5 post-install assertions (INST-01..04) — depends on 43 — COMPLETE 2026-05-12
  ...
  - [x] Plan 44-03: stepAssertions() with 5 FROZEN post-install assertions (skill_files_present, compiler_validates, daemon_health, schema_applied, semgrep_rules_present) + worst-of combinator + totalSteps bumped 6→7 + tests/init-assertions.test.cjs (10 tests) + tests/init-smoke.test.cjs (8 subprocess tests) — COMPLETE 2026-05-12
- [x] **Phase 44: Cross-IDE Installer** — COMPLETE 2026-05-12 (3 plans, 47 tests)
...
- [ ] **Phase 47: Agent Dynamic Hydration** — Agent .md templates with dynamic sections; operator queries PG/blackboard/Valkey/security for agent-specific context injection (HYDRA-01..02) — depends on 42+43 [Plan 47-00 COMPLETE: Migration 020 schema substrate]
