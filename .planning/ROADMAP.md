...
- [ ] **Phase 51: Party Mode Decisions + Operator CLI** — Structured decision records (propose/agree/dissent/block) + `gsd-amauta party status/inspect/kill` subcommands (PARTY-03, PARTY-04). Depends on 50. Plan 51-01 COMPLETE (2026-05-13): migration 023 UP+DOWN + DECISION_TYPES + post_decision/list_decisions/summarize_decisions + 11 tests.
