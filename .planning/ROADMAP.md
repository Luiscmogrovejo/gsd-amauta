...
- [ ] **Phase 52: Agent Compilation** — Canonical AGENT.yaml schema + `gsd-tools agents compile` symmetric with Phase 43 skill compiler + per-IDE alias tables + optional compile-time hydration bake (COMPILE-01, COMPILE-02, COMPILE-03, COMPILE-04). Plan 52-01 complete (2026-05-13): AgentDefinition Pydantic schema + agent-md-to-yaml.cjs converter + 24 tests.
