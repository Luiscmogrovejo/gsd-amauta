...
const CODEX_AGENT_SANDBOX = {
  ...
  'gsd-executor-mobile-android': 'workspace-write',
  'gsd-executor-mobile-ios': 'workspace-write',
  'gsd-executor-mobile-cross': 'workspace-write',
  'gsd-executor-wearables': 'workspace-write',
  'gsd-executor-ai': 'workspace-write',
...
const banner = '\n' +
  ...
  '  ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝ ╚═════╝    ╚═╝   ╚═╝  ╚═╝' + reset + '\n' +
  '\n' +
  '  Amauta ' + dim + 'v' + pkg.version + reset + '\n' +
  '  Multi-agent task management with RPETD pipeline\n' +
...
function uninstall(isGlobal, runtime = 'claude') {
  ...
  console.log(`
  ${green}Done!${reset} Amauta has been uninstalled from ${runtimeLabel}.
...
function finishInstall(settingsPath, settings, statuslineCommand, shouldInstallStatusline, runtime = 'claude', isGlobal = true) {
  ...
  Open a project directory and run ${cyan}${command}${reset}.

  ${cyan}Docs:${reset} https://github.com/robertamauta/gsd-amauta
`);
}
