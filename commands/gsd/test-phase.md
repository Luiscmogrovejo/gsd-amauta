...
**Argument formats:**
- Phase number: `/gsd:test-phase 3` — runs tests for all tasks in phase 3
- Task ID: `/gsd:test-phase TK-0042` — runs tests for a specific amauta task
- With custom test command: `/gsd:test-phase 3 --test-cmd "pytest -v"`
- With explicit task target: `/gsd:test-phase 3 --task TK-0042`
