...
### Mobile-UAT Ground Truth (MOBL-05)

Accessibility-tree snapshot diffs are the only hard-gate mobile-UAT artifact;
pixel/screenshot checks are advisory only and can never fail a task alone.
Full checklist: runtime Read
`get-shit-done/references/mobile-uat-checklist.md`.
