...
**Wave is pre-computed:** Wave numbers are assigned during `/amauta:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
