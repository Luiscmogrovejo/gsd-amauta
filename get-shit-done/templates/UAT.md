...
- This section feeds directly into /amauta:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /amauta:plan-phase --gaps with root causes
...
**Creation:** When /amauta:verify-work starts new session
