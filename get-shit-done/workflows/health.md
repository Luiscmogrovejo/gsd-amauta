...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /amauta:health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /amauta:new-project to create
```
...
- [W001] STATE.md references phase 5, but only phases 1-3 exist
  Fix: Run /amauta:health --repair to regenerate
...
```
---
N issues can be auto-repaired. Run: /amauta:health --repair
```
</step>
...
```
Would you like to run /amauta:health --repair to fix N issues automatically?
```
