<purpose>
Capture an idea, task, or issue that surfaces during an Amauta session as a structured todo for later work. Enables "thought → capture → continue" flow without losing context.
</purpose>
...
- `/amauta:add-todo Add auth token refresh` → title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/amauta:check-todos)
```
</step>
