...
- Example: `/amauta:remove-phase 17` → phase = 17
- Example: `/amauta:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /amauta:remove-phase <phase-number>
Example: /amauta:remove-phase 17
```
...
To abandon current work, use /amauta:pause-work instead.
```
...
Would you like to:
- `/amauta:progress` — see updated roadmap status
