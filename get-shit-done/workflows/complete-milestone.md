...
2. **Run audit first** — `/amauta:audit-milestone` to assess gap severity
...
If "Skip": Phase directories remain in `.planning/phases/` as raw execution history. Use `/amauta:cleanup` later to archive retroactively.
...
- [ ] User knows next step (/amauta:new-milestone)
