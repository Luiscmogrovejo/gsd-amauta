...
- Check for MILESTONE-CONTEXT.md (from /amauta:discuss-milestone)
...
**Persist choice to config** (so future `/amauta:plan-phase` honors it):
...
| GATES | Versions current (verify with $RESEARCH search or official docs), rationale explains WHY, integration considered | Categories clear, complexity noted, dependencies identified | Integration points identified, new vs modified explicit, build order considers deps | Pitfalls specific to adding these features, integration pitfalls covered, prevention actionable |
...
`/amauta:discuss-phase [N]` — gather context and clarify approach

<sub>`/clear` first → fresh context window</sub>

Also: `/amauta:plan-phase [N]` — skip discussion, plan directly
```
...
- [ ] User knows next step: `/amauta:discuss-phase [N]`
