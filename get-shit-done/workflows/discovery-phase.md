...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /amauta:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/amauta:discuss-phase [current-phase])
2. Create phase plan (/amauta:plan-phase [current-phase])
