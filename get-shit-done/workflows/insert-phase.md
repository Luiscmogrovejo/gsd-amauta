...
Example: `/amauta:insert-phase 72 Fix critical auth bug`
-> after = 72
...
Usage: /amauta:insert-phase <after> <description>
Example: /amauta:insert-phase 72 Fix critical auth bug
```
...
`/amauta:plan-phase {decimal_phase}`
...
- Don't use this for planned work at end of milestone (use /amauta:add-phase)
- Don't insert before Phase 1 (decimal 0.1 makes no sense)
- Don't renumber existing phases
- Don't modify the target phase content
- Don't create plans yet (that's /amauta:plan-phase)
