...
STOP. Workflow complete. Save final StepHandoff with next_step=null via POST /api/steps/discuss-phase/{PHASE}/handoff and return control to the workflow router.
