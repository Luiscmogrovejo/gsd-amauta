...
Exit skill and invoke SlashCommand("/amauta:plan-phase [X+1] --auto")
...
Exit skill and invoke SlashCommand("/amauta:discuss-phase [X+1] --auto")
...
`/amauta:discuss-phase [X+1]` — gather context and clarify approach
...
**Also available:**
- `/amauta:plan-phase [X+1]` — skip discussion, plan directly
- `/amauta:research-phase [X+1]` — investigate unknowns
...
**Also available:**
- `/amauta:discuss-phase [X+1]` — revisit context
- `/amauta:research-phase [X+1]` — investigate unknowns
...
Exit skill and invoke SlashCommand("/amauta:complete-milestone {version}")
